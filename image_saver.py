...
import threading
from stream_utilis import frame_stack, flow_magnitude_normalized, FLAGS

SAVE_FOLDER = "data/captured_images"
os.makedirs(SAVE_FOLDER, exist_ok=True)

collecting_images = False
BACKGROUND_INTERVAL_SECONDS = 60  # Save neutral frames every 60 seconds
...
def start_periodic_image_saving(interval_seconds=2, mean_norm=0.4):
    ...
    def save_loop():
        ...
        while collecting_images:
            ...
            if len(frame_stack) > 1 and flow_magnitude_normalized.mean() >= float(mean_norm):
